...
w("system prompt no longer tells the dogs apart. The Piper voice does: `aru` is snapper, `alan` is")
w("helper. The index carries `group` (machine), `persona` (prompt) and `voice` separately.")
w("")
